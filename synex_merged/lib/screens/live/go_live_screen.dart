...
class _GoLiveScreenState extends State<GoLiveScreen> {
  ...
  Future<void> _startLive() async {
    ...
    try {
      ...
      // Firebase Auth se directly UID lo — reliable hai
      ...
      // UserModel available ho toh use karo, warna Firebase user data
      ...
      if (liveId == null) {
        AppHelpers.showSnackBar(
            context, 'Live start nahi hua. Internet check karo.', isError: true);
        setState(() => _loading = false);
      } else {
        ...
        Container(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              const Text('Ready to go Live!',
                style: TextStyle(color: AppTheme.liveRed, fontSize: 14, fontWeight: FontWeight.w600)),
            ]),
          ])),
